...
<%
	...
	Dim pid As Integer = CInt(Request.QueryString("pid"))
        ...
        <div id="content">
            <div id="topbox">
            	...
            	<% if len(p.image) > 0 %>
            		...
            		<img src="upload/page/<%=p.image%>" width="934" height="159" alt="" />
                    
                <% else %>
                	
                    <img src="images/template_header.jpg" alt="" />
            ...
            <div id="middlebox_top">
            	<div id="middlebox_content">
                	<div id="middlebox_content_top">
                        <div id="middlebox_content_left">
                        
                            <!--#include file="_includes/navigationSubmenu.aspx"-->
                            
                        </div>
                        
                        
                        
                        <div id="middlebox_content_right">
