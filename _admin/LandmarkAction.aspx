...
<%
	...
	' data variables	
	dim sName As String = db.Prepare(""& Request.Form("landmark"),false)
	...
	Dim sTableName As String = "tblLandmarks"				' name of the database table to perform actions on
	Dim sPrimaryKey As String = "id"				' name of the primary key field in the database
	Dim sRedirectURL As String = "LandmarkList.aspx"		' url to redirect to once action is complete
	Dim sDetailURL As String = "LandmarkDetail.aspx"		' url to redirect to detail page
	Dim sColumnNames() As String = { "landmark","SortOrder" }
	Dim sValues() As String = { sName, 1 }
	'###############################################################################################################################
