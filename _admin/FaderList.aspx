...
<%
	...
	Dim sFormDetailURL As String = "FaderDetail.aspx"	' filename of the detail page used for this module
	...
	Dim sColumnHeaders() As String = { "Image","Sort","Action" }
	' data specific vars
	Dim iID As Integer
	...
	while db.InResults()
		...
		sTitle = db.GetItem("filename")
		
		sPageData += "<tr><th scope='row' class='specalt' width='500'><img src='../upload/homepage/fader/"& sTitle &"' height='100'/></th>"
		if iRecCount = 0 then
