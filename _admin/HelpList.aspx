...
<%
	...
	Dim sPageObject As String = "Help Option"					' The type of page, used for text display to identify what is going on
	Dim sFormActionURL As String = "HelpAction.aspx"	' filename of the action page used for this module
	Dim sFormDetailURL As String = "HelpDetail.aspx"	' filename of the detail page used for this module
