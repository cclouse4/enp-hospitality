...
<%
	...
	' data variables	
	Dim v As New Fader
	v.image = db.Prepare(""& Utilities.GetFilenameByKey("filename"))
	...
	Dim sTableName As String = "tblFader"				' name of the database table to perform actions on
	Dim sPrimaryKey As String = "id"				' name of the primary key field in the database
	Dim sRedirectURL As String = "FaderList.aspx"		' url to redirect to once action is complete
	Dim sDetailURL As String = "FaderDetail.aspx"		' url to redirect to detail page
	Dim sColumnNames() As String = { "filename","SortOrder" }
	Dim sValues() As String = { v.image,1 }
	'###############################################################################################################################
