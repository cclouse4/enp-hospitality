...
<%
	...
	Dim sFormDetailURL As String = "GlossaryDetail.aspx"	' filename of the detail page used for this module
	...
	Dim sColumnHeaders() As String = { "title","Action" }
	' data specific vars
	Dim iID As Integer
	...
	db.RunQuery("select * from "& sTableName &" order by cast(title as nvarchar(250)) asc")
	
	while db.InResults()
		iID = db.GetItem(sPrimaryKey)
		sTitle = db.GetItem("title")
