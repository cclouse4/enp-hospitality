...
<%
	...
	Dim sFormDetailURL As String = "LandmarkDetail.aspx"	' filename of the detail page used for this module
	...
	while db.InResults()
		...
		sPageData += "<th class='specalt' width='250'><a href='"& sFormDetailURL &"?Action=Edit&"& sPrimaryKey &"="& iID &"'>edit</a> | <a href='"& sFormDetailURL &"?Action=Delete&"& sPrimaryKey &"="& iID &"'>delete</a>"
